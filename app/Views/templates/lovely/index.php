...
<head>
    ...
    <style>
        ...
        body { font-family: var(--t-body-font); }
        h1, h2, h3, .couple-name-merried-text h2 { font-family: var(--t-heading-font); }
        .navbar-brand, .submit, .back-to-top-btn span { background: var(--t-primary); }
        .section-title .vertical-line span, .section-title-white .vertical-line span { color: var(--t-primary); }
        .wedding-announcement .save-the-date .date { color: var(--t-primary); }
        .submit:hover { opacity: .92; }

        /* Registry styles */
        .registry-kpis .kpi { background:#fff; border-radius:10px; padding:18px; box-shadow:0 8px 20px rgba(0,0,0,.05); margin-bottom:18px; }
        .registry-kpis .kpi .icon { width:42px; height:42px; border-radius:10px; display:inline-flex; align-items:center; justify-content:center; margin-right:10px; background:var(--t-accent); }
        .registry-item { background:#fff; border-radius:12px; box-shadow:0 10px 25px rgba(0,0,0,.06); overflow:hidden; margin-bottom:24px; }
        .registry-item .thumb { width:100%; height:230px; object-fit:cover; background:#f3f3f3; }
        .registry-item .body { padding:18px; }
        .badge-claimed { display:inline-block; padding:6px 10px; border-radius:999px; background:#1f9d55; color:#fff; font-size:12px; font-weight:600; }
