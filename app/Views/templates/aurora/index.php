...
$assetsBase = base_url('templates/aurora');
...
$primaryColor = $theme['primary'] ?? '#1b2838';
$accentColor  = $theme['accent'] ?? '#f4c7a8';
$bgColor      = $theme['background'] ?? '#f7f5f1';
...
<body>
        ...
        <header class="hero">
            ...
            <div class="container hero__inner">
                <div class="hero__text">
                    <span class="hero__label">Celebramos nuestro amor</span>
                    <h1><?= $coupleTitle ?></h1>
    ...
    <main>
        <?php if (isSectionVisible($sectionVisibility, 'couple')): ?>
            <section class="section">
                ...
                <div>
                    <h2>Bienvenida</h2>
                    <p><?= $storyText ? esc($storyText) : 'Gracias por ser parte de esta celebración. Aquí encontrarás toda la información disponible para disfrutar con nosotros.' ?></p>
                    <?php if ($venueNote): ?>
                        <div class="tagline"><?= esc($venueNote) ?></div>
                    <?php endif; ?>
                </div>
            ...
            <section class="section section--dark">
                <div class="container">
                    <div class="section__header">
                        <h2>Galería</h2>
                        <p>Una vista previa de los momentos que queremos compartir.</p>
                    </div>
                    <div class="gallery">
        ...
        <?php if ($showGiftsSection && !empty($registryItems)): ?>
            <section class="section">
                <div class="container">
                    ...
                    <?php if ($registryNote): ?>
                        <p class="tagline"><?= esc($registryNote) ?></p>
                    <?php endif; ?>
                    <div class="cards">
        ...
        <?php if (($sectionVisibility['music'] ?? true) && (!empty($musicInfo) || $customHtml)): ?>
            <section class="section section--dark">
                <div class="container grid grid--split">
                    <?php if (!empty($musicInfo)): ?>
                        <div>
                            ...
                            <?php if (!empty($musicInfo['note'])): ?>
                                <p class="tagline"><?= esc($musicInfo['note']) ?></p>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                    <?php if ($customHtml): ?>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <p class="muted">13Bodas · Plantilla Aurora</p>
        </div>
    </footer>
