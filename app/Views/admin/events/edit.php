...
<ul class="nav nav-tabs mb-4" id="eventTabs" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link" href="<?= base_url('admin/events/' . $event['id'] . '/guests') ?>">
            <i class="bi bi-people me-1"></i>Invitados
        </a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link" href="<?= base_url('admin/events/' . $event['id'] . '/rsvp') ?>">
            <i class="bi bi-check2-square me-1"></i>RSVPs
        </a>
    </li>
    <li class="nav-item" role="presentation">
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link" href="<?= base_url('admin/events/' . $event['id'] . '/registry') ?>">
            <i class="bi bi-gift me-1"></i>Regalos
        </a>
    </li>
    <li class="nav-item" role="presentation">
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link" href="<?= base_url('admin/events/' . $event['id'] . '/party') ?>">
            <i class="bi bi-hearts me-1"></i>Cortejo
        </a>
    </li>
</ul>
    ...
    <div class="tab-pane fade show active" id="info" role="tabpanel">
        <form id="eventForm" method="POST" action="<?= base_url('admin/events/update/' . $event['id']) ?>">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="<?= date('Y-m-d H:i', strtotime($event['event_date_start'])) ?>"
                                           required>
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" 
                                       ...
                                       class="form-control" 
                                       value="<?= esc($event['primary_contact_email']) ?>">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <?php if (!$isClient): ?>
                    <!-- Estado del Servicio (solo admin) -->
                    <div class="card mb-4">
                        <div class="card-header">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="bi bi-link-45deg me-2"></i>Enlace de Invitación
                        </div>
                        <div class="card-body">
    ...
    $.post('<?= base_url('admin/events/check-slug') ?>', { slug: slug, exclude_id: excludeId })
        .done(function(response) {
            ...
            if (response.available) {
                ...
                feedback.html('<span class="text-danger"><i class="bi bi-x-circle me-1"></i>No disponible</span>');
            }
        });
}
</script>
